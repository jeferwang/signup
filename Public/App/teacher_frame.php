...
<head>
	...
	<link rel="stylesheet" href="__PUBLIC__/App/style/teacher.css">
	...
	<script src="__PUBLIC__/App/js/teacher.js"></script>
...
<div id="header">
	<p>
		<span>{$Think.cookie.tCode}</span>
		<span><a href="javascript:void (0)" id="change_password">修改密码</a></span>
		<a href="{:U('Index/logout',array('type'=>'teacher'))}">
			退出
		</a>
	</p>
</div>
