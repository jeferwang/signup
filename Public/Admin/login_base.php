		...
		<div class="login">	
			...
			<table border="1" width="100%">
				...
				<tr>
					<th>验证码:</th>
					<td>
						<input type="code" class="len250" name="code" required="required"/> <img src="{:U('Login/verify')}" width="100px" height="40px" id="code"/> <a href="javascript:void(0)" onclick="changeImg()">看不清</a>
					</td>
				</tr>
				<tr>
