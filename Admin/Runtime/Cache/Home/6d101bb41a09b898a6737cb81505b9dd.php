...
<body>
	...
	<form style="margin: 20px 0 0 30px;" method="post" action="<?php echo U('People/runAdd');?>" enctype="multipart/form-data">
		<p class="info"><label for="teaname">姓名：</label><input type="text" id="teaname" name="teaname" style="height: 20px; width: 200px;" maxlength="10" />
