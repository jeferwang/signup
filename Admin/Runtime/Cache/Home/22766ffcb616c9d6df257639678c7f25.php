...
<body>
	<div id="top">
		...
		<div class="menu">
			<a href="javascript:void(0)" >当前位置:添加人才库条目</a>
	...
	<form style="margin: 20px 0 0 30px;" method="post" action="<?php echo U('Teashow/runAdd');?>" enctype="multipart/form-data">
		<p class="info"><label for="teaname">姓名：</label><input type="text" id="teaname" name="teaname" style="height: 20px; width: 200px;" maxlength="10" required="required" />
			<input type="submit" id="submit" value=">>>>添加<<<<" style="cursor: pointer;"/>
		</p>
