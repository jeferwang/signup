...
<!--网页标题-->
<block name="title">后台管理-添加人才库条目</block>
<!--样式表和js引入-->
<block name="css_js">
	<style type="text/css">
	    .info{
...
<!--当前位置-->
<block name="location">添加人才库条目</block>
<!--顶部子选项菜单-->
<block name="menu">
...
<!--主要内容-->
<block name="main">
	<form style="margin: 20px 0 0 30px;" method="post" action="{:U('Teashow/runAdd')}" enctype="multipart/form-data">
